...
if plural:
    with open("/data1/yangzhenbang_new/datasets/blip_caption/coco_flickr_vg_vocab.json", 'w', encoding='utf-8') as fw:
        json.dump(res, fw, indent=4)
    print("vocab")

    with open("/data1/yangzhenbang_new/datasets/blip_caption/coco_flickr_vg_vocab_count.json", 'w',
              encoding='utf-8') as fw:
        json.dump(count, fw, indent=4)
    print("vocab_count")

else:
    with open("/data1/yangzhenbang_new/datasets/blip_caption/coco_flickr_vg_vocab_noplural.json", 'w',
              encoding='utf-8') as fw:
        json.dump(res, fw, indent=4)
    print("vocab_noplural")

    with open("/data1/yangzhenbang_new/datasets/blip_caption/coco_flickr_vg_vocab_count_noplural.json", 'w',
              encoding='utf-8') as fw:
        json.dump(count, fw, indent=4)
