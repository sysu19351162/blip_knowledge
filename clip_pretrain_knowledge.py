...
def main(args, config):
    ...
    train_dataset = create_dataset('pretrain_knowledge', config, min_scale=0.2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='output/clip_knowledge')
